...
export const Nav = () => {
  ...
  return (
    <nav className="h-16 w-full bg-black flex items-center justify-between px-4 md:px-8 relative">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden absolute top-16 right-4 bg-black text-white w-48 rounded-lg transition-transform transform ${isMenuOpen ? "translate-y-0" : "-translate-y-full"} shadow-lg`}>
